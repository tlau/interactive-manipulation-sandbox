"""autogenerated by genpy from executer_actions/ExecuteActionResult.msg. Do not edit."""
import sys
...
class ExecuteActionResult(genpy.Message):
  _md5sum = "7e5faa06674e19f52982bee5675171a8"
  _type = "executer_actions/ExecuteActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','executer_actions/ExecuteResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecuteActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = executer_actions.msg.ExecuteResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = executer_actions.msg.ExecuteResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.result.outputs
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.result.retval))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.outputs = str[start:end].decode('utf-8')
      else:
        self.result.outputs = str[start:end]
      start = end
      end += 1
      (self.result.retval,) = _struct_B.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
