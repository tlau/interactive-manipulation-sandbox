"""autogenerated by genpy from executer_actions/ExecuteActionFeedback.msg. Do not edit."""
import sys
...
class ExecuteActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "executer_actions/ExecuteActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','executer_actions/ExecuteFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecuteActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = executer_actions.msg.ExecuteFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = executer_actions.msg.ExecuteFeedback()
