"""autogenerated by genpy from activity_msgs/ExecuteActionResult.msg. Do not edit."""
import sys
...
class ExecuteActionResult(genpy.Message):
  ...
  _type = "activity_msgs/ExecuteActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','activity_msgs/ExecuteResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = activity_msgs.msg.ExecuteResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = activity_msgs.msg.ExecuteResult()
