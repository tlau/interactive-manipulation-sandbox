"""autogenerated by genpy from activity_msgs/StartActivityActionResult.msg. Do not edit."""
import sys
...
class StartActivityActionResult(genpy.Message):
  _md5sum = "884879166c74c7c239fcc50974452423"
  _type = "activity_msgs/StartActivityActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','activity_msgs/StartActivityResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StartActivityActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = activity_msgs.msg.StartActivityResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = activity_msgs.msg.StartActivityResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_QB.pack(_x.result.activity_id, _x.result.error_code.val))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.activity_id, _x.result.error_code.val,) = _struct_QB.unpack(str[start:end])
      return self
