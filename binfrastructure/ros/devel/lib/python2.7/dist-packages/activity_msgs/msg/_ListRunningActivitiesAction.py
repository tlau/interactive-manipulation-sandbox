"""autogenerated by genpy from activity_msgs/ListRunningActivitiesAction.msg. Do not edit."""
import sys
...
class ListRunningActivitiesAction(genpy.Message):
  _md5sum = "52baed03ed8eac77c5487037348ce3be"
  _type = "activity_msgs/ListRunningActivitiesAction"
...
"""
  ...
  _slot_types = ['activity_msgs/ListRunningActivitiesActionGoal','activity_msgs/ListRunningActivitiesActionResult','activity_msgs/ListRunningActivitiesActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ListRunningActivitiesAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = activity_msgs.msg.ListRunningActivitiesActionGoal()
      if self.action_result is None:
        self.action_result = activity_msgs.msg.ListRunningActivitiesActionResult()
      if self.action_feedback is None:
        self.action_feedback = activity_msgs.msg.ListRunningActivitiesActionFeedback()
    else:
      self.action_goal = activity_msgs.msg.ListRunningActivitiesActionGoal()
      self.action_result = activity_msgs.msg.ListRunningActivitiesActionResult()
      self.action_feedback = activity_msgs.msg.ListRunningActivitiesActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_result.result.running_activities)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.running_activities:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.running_activities = []
      for i in range(0, length):
        ...
        self.action_result.result.running_activities.append(val1)
      _x = self
      start = end
      end += 12
