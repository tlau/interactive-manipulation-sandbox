"""autogenerated by genpy from activity_msgs/StopActivityAction.msg. Do not edit."""
import sys
...
class StopActivityAction(genpy.Message):
  _md5sum = "11546d317986cf291c1e5bee51241066"
  _type = "activity_msgs/StopActivityAction"
...
"""
  ...
  _slot_types = ['activity_msgs/StopActivityActionGoal','activity_msgs/StopActivityActionResult','activity_msgs/StopActivityActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StopActivityAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = activity_msgs.msg.StopActivityActionGoal()
      if self.action_result is None:
        self.action_result = activity_msgs.msg.StopActivityActionResult()
      if self.action_feedback is None:
        self.action_feedback = activity_msgs.msg.StopActivityActionFeedback()
    else:
      self.action_goal = activity_msgs.msg.StopActivityActionGoal()
      self.action_result = activity_msgs.msg.StopActivityActionResult()
      self.action_feedback = activity_msgs.msg.StopActivityActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_Q3I.pack(_x.action_goal.goal.activity_id, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3I.pack(_x.action_result.result.error_code.val, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.activity_id, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_Q3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.error_code.val, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
