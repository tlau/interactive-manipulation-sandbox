"""autogenerated by genpy from activity_msgs/StartActivityActionFeedback.msg. Do not edit."""
import sys
...
class StartActivityActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "activity_msgs/StartActivityActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','activity_msgs/StartActivityFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StartActivityActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = activity_msgs.msg.StartActivityFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = activity_msgs.msg.StartActivityFeedback()
