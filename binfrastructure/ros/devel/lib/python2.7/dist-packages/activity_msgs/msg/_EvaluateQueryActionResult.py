"""autogenerated by genpy from activity_msgs/EvaluateQueryActionResult.msg. Do not edit."""
import sys
...
class EvaluateQueryActionResult(genpy.Message):
  _md5sum = "5489bcfa93e36e07a0b801f3ac4c7c97"
  _type = "activity_msgs/EvaluateQueryActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','activity_msgs/EvaluateQueryResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(EvaluateQueryActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = activity_msgs.msg.EvaluateQueryResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = activity_msgs.msg.EvaluateQueryResult()
