"""autogenerated by genpy from activity_msgs/EvaluateQueryAction.msg. Do not edit."""
import sys
...
class EvaluateQueryAction(genpy.Message):
  _md5sum = "04a6c8fdab35fa9fff022b015299271d"
  _type = "activity_msgs/EvaluateQueryAction"
...
"""
  ...
  _slot_types = ['activity_msgs/EvaluateQueryActionGoal','activity_msgs/EvaluateQueryActionResult','activity_msgs/EvaluateQueryActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(EvaluateQueryAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = activity_msgs.msg.EvaluateQueryActionGoal()
      if self.action_result is None:
        self.action_result = activity_msgs.msg.EvaluateQueryActionResult()
      if self.action_feedback is None:
        self.action_feedback = activity_msgs.msg.EvaluateQueryActionFeedback()
    else:
      self.action_goal = activity_msgs.msg.EvaluateQueryActionGoal()
      self.action_result = activity_msgs.msg.EvaluateQueryActionResult()
      self.action_feedback = activity_msgs.msg.EvaluateQueryActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.query.query
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.query.args)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.query.args:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.query.query = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.query.query = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.query.args = []
      for i in range(0, length):
        ...
        self.action_goal.goal.query.args.append(val1)
      _x = self
      start = end
      end += 12
