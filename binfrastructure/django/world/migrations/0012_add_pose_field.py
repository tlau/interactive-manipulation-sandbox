...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BinLocation.pose'
        db.add_column('world_binlocation', 'pose',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['world.Pose'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BinLocation.pose'
        db.delete_column('world_binlocation', 'pose_id')
    ...
    models = {
        ...
        'world.binlocation': {
            ...
            'pose': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['world.Pose']", 'unique': 'True', 'null': 'True'})
        },
        'world.pose': {
